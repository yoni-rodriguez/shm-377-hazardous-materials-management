...
/* ---------------------------------------------------------
   ...
   Instructions and choices left, QR code right
   --------------------------------------------------------- */
...
@media (max-width: 768px) {
  ...
  /* Poll Everywhere stacks vertically on small screens */
  .poll-layout {
    display: block !important;
  }
...
![](poll-everywhere-response.jpg){fig-alt="QR code to join the SHM 377 Poll Everywhere presentation" width="250"}
:::
::::::
...
Hazardous materials management requires more than identifying whether something is hazardous.

We need to understand:

- **what the material is**
- **what hazardous properties it has**
- **how people or the environment could be exposed**
- **how much exposure could occur**
- **how the material should be handled, controlled, and managed**
- **what regulations and communication systems apply**

> **Hazardous materials management is the process of recognizing hazards, understanding potential exposures, and making informed decisions about how materials should be managed throughout their life cycle.**
...
| Hazardous material | A material or substance whose properties can pose a risk to human health, safety, property, or the environment. |
| Dose-response relationship | The relationship between the amount of exposure and the resulting biological effect. |
| Hazard communication | Systems used to communicate information about hazardous materials, including labels, Safety Data Sheets, placards, and hazard-identification systems. |
| Hazardous-material life cycle | The stages through which a hazardous material may be acquired, stored, used, transported, released, managed as waste, and disposed. |
