...
/* ---------------------------------------------------------
   SHM 377 Lecture Typography
   Keep body text and blockquotes visually consistent
   --------------------------------------------------------- */

/* Use the normal document text color throughout */
body {
  color: #212529;
}

/* Keep blockquotes consistent with normal lecture text */
blockquote {
  color: #212529;
  font-size: inherit;
  font-style: normal;
...
/* Do not alter intentional bold text inside blockquotes */
blockquote strong {
  color: #212529;
}

/* Keep centered lecture content the same color as body text */
.text-center {
  color: #212529;
}

/* Align images in the Types of Hazards section */
.hazard-list {
  min-height: 165px;
}
